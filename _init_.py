...
if __name__ == '__main__':
    ...
    data_source = "https://store44data.blob.core.windows.net/store44data/Store44.zip?sp=r&st=2021-11-27T15:35:22Z&se=2021-11-30T23:35:22Z&sv=2020-08-04&sr=b&sig=KpE%2FUItwK%2F0LPntutAHjgViIeloF%2BYoomJntw0TyZIc%3D"
    ...
    # Reference
    result = sample.detect(model_id, datetime(2016, 8, 15, 0, 0, 0, tzinfo=timezone.utc),
